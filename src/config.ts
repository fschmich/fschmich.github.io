export const siteConfig = {
  ...
  aboutMe:
    "Computational Biology PhD from ETH with 15+ years of experience in machine learning and 8+ years in pharmaceutical R&D, I currently work as a Senior Principal Data Scientist and AI Capability Lead at <a href='https://www.roche.com/' target='_blank' rel='noopener noreferrer'>Roche</a>. In these roles, I lead global cross-functional teams to tackle complex biological and clinical challenges, making medicines for patients. ",
